...
| **12.4** | Team digest + no-surveillance — **J3 day-30 scene** (journey closer) | Digest Spirit reads only consented topics under its own tuples; narrative team digest across the 8-Host mesh consuming the 12.3 receipt stream; surveillance-negative control; **J3 day-30 Marcus standup scene E2E** on the journey-acceptance harness. | 6 | frontier + **full §A6** (journey + no-surveillance) | ZERO (digest is Spirit-side) | 12.2, 12.3 |
...
**12.4 — Team digest + no-surveillance — J3 day-30 scene (journey closer)**
