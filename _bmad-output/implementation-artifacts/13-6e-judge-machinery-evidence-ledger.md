...
Status: **in-progress** — reopened 2026-08-08 by Story 13.6 documentation review; published-ledger validation does not reject omission of a gate-mandatory leg.
...
- [ ] [Review][Patch] [HIGH] Require the complete gate-owned leg set when validating a published ledger [xtask/src/evidence_ledger.rs:1247]
