...
The closure's production code breached **three** ceilings. Measured at the session's entry commit `c6977b35` and at the closure commit `1c9efcdd`, formatted tree both times:

| Crate | Entry `c6977b35` | Close `1c9efcdd` | Old ceiling | Over | Granted |
|---|---|---|---|---|---|
