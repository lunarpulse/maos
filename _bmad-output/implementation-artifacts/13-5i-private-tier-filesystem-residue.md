...
| Date | Change |
|---|---|
| 2026-08-02 | CI-blocker review tightened the existing PID-symlink containment control from safe skip to fail-closed error, matching the approved hostile-path contract while preserving the external target. |
